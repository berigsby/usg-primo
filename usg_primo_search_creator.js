...
function createDeepSearchLink() {
	...
	if(isEmpty(criteria)) {
		var d = new Date();
		var n = d.getTime();
		$('#result').val('<div>\r	<form>\r		<label for="' + n + '">' + label + '</label>\r		<input type="text" id="' + n + '">\r		<a class="search_link' + n + '">\r			<button onclick="function'+n+'()" type="submit">Search</button>\r		</a>\r		<script type="text/javascript">\r		function function'+ n + '(){\r			var target = "');
